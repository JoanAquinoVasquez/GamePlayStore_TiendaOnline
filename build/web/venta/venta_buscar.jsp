...
//////
    int t_lista_ventas = 0;
    List<Beans_venta> lista_ventas = new ArrayList<>();
    if (request.getSession().getAttribute("lista_ventas") != null) {
        lista_ventas = (List) request.getSession().getAttribute("lista_ventas");
        t_lista_ventas = lista_ventas.size();
    } else {
                             ...
                             <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item menu-open">
                                        ...
                                        <ul class="nav nav-treeview">
                                            <li class="nav-item">
                                                <a href="../venta/venta_buscar.jsp" class="nav-link active">
                                                    <i class="far fa-circle nav-icon"></i>
                                                    <p>Buscar Venta</p>
                                                </a>
                                            </li>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active"><a href="venta_buscar.jsp">Buscar Venta</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                                ...
                                <div class="card">
                                    <div class="card-header">
                                        <form action="venta_control.jsp" method="post">
                                            <input type="number" min="1" id="txt_usuario" name="txt_codigoventa" width="50" required="">
                                            ...
                                            <a href="venta_nuevo.jsp" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Nuevo venta</span></a>					
                                        </form> 
                                        <form action="venta_control.jsp" method="post">
                                              <input type="text" class="btn-nuevo" id="txt_operacion" name="txt_operacion" value="LISTAR" hidden>
                                              <input type="submit" value="Listar" class="btn btn-dark"> 
                                        </form>
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <table id="example2" class="table table-bordered table-striped table-hover dataTable no-footer dtr-inline collapsed" aria-describedby="example2_info">
                                            ...
                                            <tbody>
                                                <%                        int i = 0;
                                                    while (i < t_lista_ventas) {
                                                %>
                                                <tr>
                                                    <td><%= lista_ventas.get(i).getCodigoventa() %></td>
                                                    <td><%= lista_ventas.get(i).getFecha() %></td>
                                                    <td><%= lista_ventas.get(i).getHora() %></td>
                                                    <td><%= lista_ventas.get(i).getSubtotal() %></td>
                                                    <td><%= lista_ventas.get(i).getIgv() %></td>
                                                    <td><%= lista_ventas.get(i).getTotal()  %></td>
                                                </tr>
                                                <%
                                                        i = i + 1;
                                                    }
