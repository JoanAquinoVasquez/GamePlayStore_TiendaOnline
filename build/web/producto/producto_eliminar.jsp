...
<html lang="en">
    <head>
        ...
        <title>Eliminar Producto | GamePlayStore</title>
    ...
    <body class="hold-transition sidebar-mini layout-fixed">
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active"><a href="#">Eliminar Producto</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                                    ...
                                    <form id="form1" action="" method="post" enctype="multipart/form-data">
                                        <div class="card-body">
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input type="input" name="nombre" id="nombre" value="<%= lista_recibe1.get(0).getNombre_producto()%>" disabled="">

                                            </div>

                                            <div class="form-group">
                                                <label>Archivo</label>
                                                <a href="../servidor/<%=lista_recibe1.get(0).getArchivo()%>" width="100"><br><%= lista_recibe1.get(0).getArchivo()%></a>

                                            </div>
                                            <div class="form-group">
                                                <label>Imagen</label>
                                                <img src="../servidor/<%=lista_recibe1.get(0).getImagen()%>" width="100"><%=lista_recibe1.get(0).getImagen()%>
                                            </div>
                                            <div class="form-group">
                                                <label>Categoria</label>
                                                <select class="form-control col-3 select2" name="select_categoria" disabled="">
                                                ...
                                                <input type="text" name="fecha_produccion" data-date="" data-date-format="DD MMMM YYYY" value="<%= lista_recibe1.get(0).getFecha_produccion()%>" disabled="">
                                            </div>
                                            <div class="form-group">
                                                <label>Precio</label>
                                                <input class="col-2" name="precio" type="number" min="0" step="0.10" value="<%= lista_recibe1.get(0).getPrecio()%>" disabled="">
                                                <label class="col-3"></label>
                                                <label>Stock</label>
                                                <input class="col-2" name="stock" type="number" min="0" value="<%= lista_recibe1.get(0).getStock()%>" disabled="" >
                                            </div>
                                            <div class="form-group clearfix">
                                                <label>Conexión</label>
                                                <div class="icheck-primary d-inline">
                                                    <input class="col-1" name="checkbox" type="checkbox" value="0" id="inalambrico" checked="" disabled="" >
                                                    <label for="inalambrico">Inalambrico
                                                    </label>
                                                </div>
                                                <div class="icheck-danger d-inline">
                                                    <input  class="col-1" name="checkbox" type="checkbox" value="0" id="usb" checked="" disabled="">
                                                    <label for="usb">Tipo USB
                                                    </label>
                                                </div>
                                                <div class="icheck-success d-inline">
                                                    <input type="checkbox" name="checkbox"  value="0" id="usbc" checked="" disabled="">
                                            ...
                                            <div class="form-group">
                                                <label>Estado</label>
                                                <select name="select_eliminado" disabled="" >
                                            ...
                                            <div class="form-group">
                                                ...
                                                <input type="submit" class="btn btn-danger" name="btn1" id="btn1" value="Eliminar" onClick="cf1()">
        ...
        <%
            Dao_producto d_a4 = new Dao_producto();
            d_a4.producto_d_eliminacion_logica(codigo_producto);
