...
<html lang="en">
    <head>
        ...
        <title> Menu Principal | GamePlayStore</title>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    <li class="breadcrumb-item active"><a href="menu.jsp">Menu Principal</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-info">
                                    ...
                                    <a href="../categoria/categoria_listar.jsp" class="small-box-footer">Más información <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-success">
                                    <div class="inner">
                                        <h4>Productos</h4>
                                        <h3><%= num_productos%><sup style="font-size: 20px"></sup></h3>
                                    </div>
                                    <div class="icon">
                                        <i class="fas fa-box"></i>
                                    </div>
                                    <a href="../producto/producto_listar.jsp" class="small-box-footer">Más información <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
                                ...
                                <div class="small-box bg-warning">
                                    ...
                                    <a href="../venta/venta_buscar.jsp" class="small-box-footer">Más información <i class="fas fa-arrow-circle-right"></i></a>
                                </div>
                            </div>
                            <!-- ./col -->
                            <div class="col-lg-3 col-6">
