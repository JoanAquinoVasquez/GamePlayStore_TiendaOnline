...
<html lang="en">
    <head>
        ...
        <title>Nueva Categoria | GamePlayStore</title>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active"><a href="categoria_nuevo.jsp">Nueva Categoria</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                                    ...
                                    <form action="categoria_control.jsp" method="post">
                                        <div class="card-body">	
                                            <div class="form-group">
                                                ...
                                                <input type="text" value="<%= t_lista_categorias + 1%>" class="form-control col-2" disabled="">
                                            </div>			
                                            <div class="form-group">
                                                <label>Nombre</label>
                                                <input type="text" name="txt_nombre_categoria" class="form-control" placeholder="Ingrese el nombre de la categoria" required>
                                            </div>		
                                            <div class="form-group">
                                            ...
                                            <input type="text" name="txt_operacion" value="INSERTAR" hidden>
