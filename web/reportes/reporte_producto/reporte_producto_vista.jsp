...
<html lang="en">
    <head>
        ...
        <title> Reporte Productos | GamePlayStore</title>
                        ...
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    ...
                                    <li class="nav-item">
                                        <a href="../reporte_producto/reporte_producto_vista.jsp" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h2 class="m-0">Reporte de <b>Productos</b></h2>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active"><a href="../../reportes/reporte_producto/reporte_producto_vista.jsp">Producto</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-6">
                                ...
                                <div id="divIngreseBuscar">
                                    <form action="reporte_producto_consulta.jsp" method="post" target="ventana_iframe">
