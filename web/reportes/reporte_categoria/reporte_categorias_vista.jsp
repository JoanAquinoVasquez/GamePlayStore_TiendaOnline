...
<html lang="en">
    <head>
        ...
        <title> Reporte Categorias | GamePlayStore</title>
                    ...
                    <nav class="mt-2">
                        <ul class="nav nav-pills nav-sidebar flex-column" data-widget="treeview" role="menu" data-accordion="false">
                            ...
                            <li class="nav-item menu-open">
                                ...
                                <ul class="nav nav-treeview">
                                    <li class="nav-item">
                                        <a href="../reporte_categoria/reporte_categorias_vista.jsp" class="nav-link active">
                                            <i class="far fa-circle nav-icon"></i>
                                    ...
                                    <li class="nav-item">
                                        <a href="../reporte_venta/reporte_venta_vista.jsp" class="nav-link">
                                            <i class="far fa-circle nav-icon"></i>
            ...
            <div class="content-wrapper">
                ...
                <div class="content-header">
                    <div class="container-fluid">
                        <div class="row mb-2">
                            <div class="col-sm-6">
                                <h2 class="m-0">Reporte de <b>Categorias</b></h2>
                            </div><!-- /.col -->
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active"><a href="../../reportes/reporte_categoria/reporte_categorias_vista.jsp">Categoria</a></li>
                        ...
                        <div class="row">
                            <div class="col-lg-3 col-6">
                                ...
                                <div id="divIngreseBuscar">
                                    <form action="reporte_categorias.jsp" method="post" target="ventana_iframe">

                                        <input type="text" name="dato" id="dato" class="text-bold">
