...
//////
    ...
    if (request.getSession().getAttribute("lista_productos") != null) {
        ...
        lista_productos = d.producto_s_all();
        t_lista_productos = lista_productos.size();*/
    }
%>
...
<html lang="en">
    <head>
        ...
        <title>Buscar Producto | GamePlayStore</title>
                        ...
                        <div class="row mb-2">
                            ...
                            <div class="col-sm-6">
                                <ol class="breadcrumb float-sm-right">
                                    ...
                                    <li class="breadcrumb-item active"><a href="producto_listar.jsp">Buscar Productos</a></li>
                                </ol>
                            </div><!-- /.col -->
                        </div><!-- /.row -->
                    </div><!-- /.container-fluid -->
                            ...
                            <div class="col-12">
                                <div class="card">
                                    <div class="card-header">
                                        <form action="producto_control.jsp" method="post">
                                            <input type="text" id="txt_usuario" name="txt_nombre_producto" width="50">
                                            <input type="text" id="txt_operacion" name="txt_operacion" value="BUSCAR"  hidden>			
                                            <input type="text" class="btn-nuevo" id="txt_operacion" name="txt_operacion" value="BUSCAR" hidden>

                                            <input type="submit" value="Buscar" class="btn-danger"> 	
                                            <a href="producto_nuevo.jsp" class="btn btn-success"><i class="material-icons">&#xE147;</i> <span>Nuevo Producto</span></a>					
                                        </form>   
                                    </div>
                                    ...
                                    <div class="card-body">
                                        <table id="example2" class="table table-bordered table-striped table-hover dataTable no-footer dtr-inline collapsed" aria-describedby="example2_info">
                                            ...
                                            <tbody>
                                                ...
                                                %>
                                                <tr>
                                                    <td><%= lista_productos.get(i).getCodigo_producto()%></td>
                                                    <td><%= lista_productos.get(i).getNombre_producto()%></td>
                                                    <td><a target="_blank" href="../servidor/<%=lista_productos.get(i).getImagen()%>"><img src="../servidor/<%=lista_productos.get(i).getImagen()%>" width="100" alt="100"><br><%=lista_productos.get(i).getImagen()%></a></td>
                                                    <td><a target="_blank" href="../servidor/<%=lista_productos.get(i).getArchivo()%>" width="100"><br><%= lista_productos.get(i).getArchivo()%></a></td>
                                                    <td><%= lista_productos.get(i).getCategoria()%></td>
                                                    <td><%= lista_productos.get(i).getFecha_produccion()%></td>
                                                    <td><%
                                                        if (lista_productos.get(i).getEstado() == 0) {
                                                            out.print("VIGENTE");
                                                        } else {
                                                            out.print("ELIMINADO");
                                                        }
                                                        %></td>
                                                    <td>
                                                        <a href="producto_actualizar.jsp?codigo_producto=<%= lista_productos.get(i).getCodigo_producto()%>" class="edit" ><i class="material-icons" data-toggle="tooltip" title="Edit">&#xE254;</i></a>
                                                        <a href="producto_eliminar.jsp?codigo_producto=<%= lista_productos.get(i).getCodigo_producto()%>" class="delete" ><i class="material-icons" data-toggle="tooltip" title="Delete">&#xE872;</i></a>
                                                    </td>
                                                </tr>
                                                <%
                                                        i = i + 1;
